...
export function LoginForm() {
  ...
  return (
    <AuthCard title="Log In" subtitle="Continue building your streaks with your saved habits.">
      ...
      <p className="font-body mt-4 text-sm text-[color:var(--muted)]">
        Need an account?{' '}
        <Link className="font-medium text-[color:var(--accent-secondary)]" href="/signup">
          Sign up
        </Link>
      </p>
    </AuthCard>
